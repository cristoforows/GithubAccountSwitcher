...
enum AccountSwitcher {
    static func switchTo(_ profile: AccountProfile) throws {
        let effectiveHosts = Self.effectiveHosts(from: profile.sshHostAliases)
    ...
    private static func effectiveHosts(from aliases: [String]) -> [String] {
        var hosts = aliases
